...
Mac:
```bash
curl -C - -O https://dl.google.com/go/go1.21.4.darwin-amd64.tar.gz
sudo tar -C /usr/local -xzf go1.21.4.darwin-amd64.tar.gz
```

Linux:
```bash
curl -C - -O https://dl.google.com/go/go1.21.4.linux-amd64.tar.gz
sudo tar -C /usr/local -xzf go1.21.4.linux-amd64.tar.gz
sudo tar -C /tmp/go/local -xzf go1.21.4.linux-amd64.tar.gz
```
...
Install from source:
```bash
curl -C - -O https://dl.google.com/go/go1.21.4.src.tar.gz
