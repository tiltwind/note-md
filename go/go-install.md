...
Mac:
```bash
curl -C - -O https://dl.google.com/go/go1.20.darwin-amd64.tar.gz
sudo tar -C /usr/local -xzf go1.20.darwin-amd64.tar.gz
```

Linux:
```bash
curl -C - -O https://dl.google.com/go/go1.20.linux-amd64.tar.gz
sudo tar -C /usr/local -xzf go1.20.linux-amd64.tar.gz
sudo tar -C /tmp/go/local -xzf go1.20.linux-amd64.tar.gz
```
...
Install from source:
```bash
curl -C - -O https://dl.google.com/go/go1.20.src.tar.gz
tar -C /usr/local -xzf go1.20.src.tar.gz
cd /usr/local/go/src
time sudo ./make.bash
```
